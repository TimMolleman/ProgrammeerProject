...
# dag 19 (2 februari 2017)
- README aangepast, report afgemaakt, laatste tweaks aan grafieken en titel toegevoegd aan datamap. Bronnen toegevoegd aan data.html. Site gehost op github. Python scripts toegevoegd aan de programmeerproject map.